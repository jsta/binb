...
\tikz[overlay,remember picture] \node[opacity=0.5, at=(current page.center)]{%
  ...
  \vfill
    ...
    \begin{flushright}
    \raisebox{-8mm}[0mm]{
      \includegraphics[width=0.17\textwidth]{../logos/cont-limno.png} %
      \includegraphics[width=0.15\textwidth]{../logos/cnh-lakes.png} %
      \includegraphics[width=0.15\textwidth]{../logos/logo_msu-fw_white.png} %
      }
    \end{flushright}
 \vfill
\end{frame}
