...
\tikz[overlay,remember picture] \node[opacity=0.5, at=(current page.center)]{%
  ...
  \vfill
    ...
    \shiftleft{125pt}{
    \raisebox{-9mm}[3mm]{
      \includegraphics[width=0.11\textwidth]{../logos/cnh-lakes.png} %
      \includegraphics[width=0.11\textwidth]{../logos/logo_msu-fw_white.png} %
      \includegraphics[width=0.17\textwidth]{../logos/cont-limno_shifted.png} %
      }
      }
    \end{flushright}
 \vfill
