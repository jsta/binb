...
$if(natbib)$
\usepackage{natbib}
\bibliographystyle{$if(biblio-style)$$biblio-style$$else$apacite$endif$}
$endif$
$if(biblatex)$
...
$endif$
$if(author)$
\newcommand{\myName}{\largetext{$for(author)$$author$$sep$ \and $endfor$}
...
%   \includegraphics[width=\paperwidth]{background}};
  ...
  \vspace{2em}
    ...
    \shiftleft{125pt}{
    \raisebox{6mm}[3mm]{
      \includegraphics[width=0.11\textwidth]{/home/jose/Documents/Science/Presentations/logos/cnh-lakes.png} %
      \includegraphics[width=0.11\textwidth]{/home/jose/Documents/Science/Presentations/logos/logo_msu-fw_white.png} %
      \includegraphics[width=0.17\textwidth]{/home/jose/Documents/Science/Presentations/logos/cont-limno_shifted.png} %
      }
      }
    \end{flushright}
 \vfill
